...
const elementoBoton = document.getElementById('botonAgregar'); // Agregar el listener de click al botón
...
elementoBoton.addEventListener('click', function () {
  ...
  const elementoLista = document.getElementById('lista'); // Crear instancia de la clase que hereda de las demas o la de menor rango

  const instancia = new Mascota(elementoNombreMascota.value, elementoEnfermedad.value, elementoTipo.value, elementoPropietario.value, elementoDireccion.value, elementoTelefono.value);
